          ...
          <div className="flex items-center justify-between">
            ...
            {/* <div className="flex items-center space-x-3">
              <button
                ...
                className={`px-3 py-2 rounded-md text-sm ${activeTab === 'profile' ? 'bg-red-900/30 text-red-300' : 'text-gray-300 hover:bg-red-900/10'}`}
              >
                Profile
              </button>
              <button onClick={logout} className="px-3 py-2 rounded-md text-sm bg-transparent border border-red-800 text-red-300 hover:bg-red-900/10">
                Sign out
              </button>
            </div> */}
          </div>
