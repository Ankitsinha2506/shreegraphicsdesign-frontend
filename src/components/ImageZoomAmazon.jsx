...
const ImageZoomAmazon = ({
  ...
  // Handle click on mobile to toggle zoom
  const handleTapZoom = () => {
    if (isMobile) {
  ...
  const overlayWidth = isMobile ? width * 1.5 : zoomWidth;
  const overlayHeight = isMobile ? height * 1.5 : zoomHeight;
  const overlayLeft = isMobile ? "50%" : "70%";
  ...
  return (
    <div className="relative" style={{ width, height }}>
      ...
      <img
        ...
        onClick={handleTapZoom} // toggle zoom on mobile
      />
